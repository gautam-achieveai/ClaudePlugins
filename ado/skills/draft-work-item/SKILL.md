...
> What's next?
> 1. Start implementing — runs `/work-on 12345`
> 2. Create another work item
> 3. Done

If the user picks option 1, load and execute `ado:work-on` with the work
...
- "/draft-work-item Login page crashes when token expires"
- "/draft-work-item I need a feature to export reports as PDF"
- "/draft-work-item Refactor the database connection pool configuration"
- "/draft-work-item" (then describe interactively)
