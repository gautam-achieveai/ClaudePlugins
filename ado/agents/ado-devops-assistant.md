...
- **Work items** (create, query, update, link) → Use `ado:ado-work-items` skill
- **Create/publish PR** → Use `ado:ado-publish-pr` skill
- **Monitor/tend PR** → Delegate to `ado:ado-pr-tender` agent
